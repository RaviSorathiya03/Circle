...
export default function LampDemo() {
  return (
    <LampContainer>
      ...
      >
        Conversations build connections<br />, and connections build communities.
      </motion.h1>
    </LampContainer>
  );
}
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-slate-500 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
